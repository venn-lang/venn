...
export interface Binary extends langium.AstNode {
    readonly $container: ActionCall | Arg | Binary | Call | CaptureStmt | ContinueStmt | ExpectStmt | FnBody | ForEachStmt | IfStmt | Index | LetStmt | LifecycleDecl | ListItem | LiteralPattern | LoopState | LoopStmt | MapEntry | MatchArm | MatchExpr | MatcherClause | Member | RepeatStmt | ReturnStmt | Ternary | Unary;
...
export interface Block extends langium.AstNode {
    readonly $container: DecoDecl | FlowDecl | ForEachStmt | FragmentDecl | GroupDecl | IfStmt | LifecycleDecl | LoopStmt | MatchArm | ParallelStmt | RaceStmt | RepeatStmt | StepDecl | TryStmt;
    readonly $type: 'Block';
...
export interface Declaration extends langium.AstNode {
    readonly $type: 'ActionCall' | 'ConfigDecl' | 'Declaration' | 'DecoDecl' | 'ExpectStmt' | 'FlowDecl' | 'FnDecl' | 'ForEachStmt' | 'FragmentDecl' | 'IfStmt' | 'LetStmt' | 'LifecycleDecl' | 'LoopStmt' | 'MatchExpr' | 'MatrixDecl' | 'ParallelStmt' | 'RaceStmt' | 'RepeatStmt' | 'RunStmt' | 'TryStmt' | 'TypeDecl';
...
export type Expr = Binary | BoolLit | Call | FnExpr | Index | InstantLit | ListLit | MapLit | MatchExpr | Member | NullLit | NumberLit | Ref | StringLit | Ternary | Unary;
...
export interface ListItem extends langium.AstNode {
    readonly $container: ListLit;
...
export interface LiteralPattern extends langium.AstNode {
    readonly $container: FieldPattern | ListPattern | MatchArm;
    readonly $type: 'LiteralPattern';
    value: Expr;
}
...
export function isLiteralPattern(item: unknown): item is LiteralPattern {
    return reflection.isInstance(item, LiteralPattern.$type);
}
...
export interface MapLit extends langium.AstNode {
    readonly $container: ActionCall | Arg | Binary | Call | CaptureStmt | ConfigDecl | ContinueStmt | ExpectStmt | FnBody | ForEachStmt | IfStmt | Index | LetStmt | LifecycleDecl | ListItem | LiteralPattern | LoopState | LoopStmt | MapEntry | MatchArm | MatchExpr | MatcherClause | MatrixDecl | Member | ParallelStmt | RaceStmt | RepeatStmt | ReturnStmt | Ternary | Unary;
...
export interface MatchExpr extends Declaration, Statement {
    readonly $container: ActionCall | Arg | Binary | Call | CaptureStmt | ContinueStmt | ExpectStmt | FnBody | ForEachStmt | IfStmt | Index | LetStmt | LifecycleDecl | ListItem | LiteralPattern | LoopState | LoopStmt | MapEntry | MatchArm | MatchExpr | MatcherClause | Member | RepeatStmt | ReturnStmt | Ternary | Unary;
...
export type Pattern = LiteralPattern | NamePattern | ShapePattern;
...
export type ShapePattern = ListPattern | MapPattern;

export const ShapePattern = {
    $type: 'ShapePattern'
} as const;

export function isShapePattern(item: unknown): item is ShapePattern {
    return reflection.isInstance(item, ShapePattern.$type);
}
...
export interface Statement extends langium.AstNode {
    readonly $type: 'ActionCall' | 'BreakStmt' | 'CaptureStmt' | 'ContinueStmt' | 'ExpectStmt' | 'ForEachStmt' | 'GroupDecl' | 'IfStmt' | 'LetStmt' | 'LifecycleDecl' | 'LoopStmt' | 'MatchExpr' | 'ParallelStmt' | 'RaceStmt' | 'RepeatStmt' | 'ReturnStmt' | 'RunStmt' | 'Statement' | 'StepDecl' | 'TryStmt';
    annotations: Array<Annotation>;
}
...
export interface TypeRef extends langium.AstNode {
    readonly $container: FieldDecl | FnDecl | FnExpr | FragmentDecl | LetStmt | NamedType | Param | TypeDecl;
...
export class VennAstReflection extends langium.AbstractAstReflection {
    override readonly types = {
        ...
        ListPattern: {
            ...
            superTypes: [ShapePattern.$type]
        },
        LiteralPattern: {
            name: LiteralPattern.$type,
            properties: {
                value: {
                    name: LiteralPattern.value
                }
            },
        ...
        MatchExpr: {
            ...
            superTypes: [Declaration.$type, Statement.$type, Expr.$type]
        },
        MatcherClause: {
