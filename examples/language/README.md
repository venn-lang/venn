...
The language's own machinery: naming shapes, rewriting declarations before they run,
and splitting a program across files. For someone who has read `examples/basics/`
